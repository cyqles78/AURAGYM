...
export const BodyView: React.FC<BodyViewProps> = ({
    ...
    return (
        <div className="pb-24 pt-4 space-y-5 relative">
            ...
            {!isEditingGoal ? (
                <GlassCard className="flex flex-col">
                    ...
                    <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                        ...
                        <button onClick={() => setIsEditingGoal(true)} className="text-xs font-bold text-black bg-white px-3 py-2 rounded-full flex items-center gap-1 active:scale-95 transition">
            ...
            <div className="space-y-3">
                <div className="flex justify-between items-center px-1">
                    <h3 className="text-base font-bold text-white flex items-center gap-2"><Ruler size={16} /> Measurements</h3>
                </div>
            ...
            <div className="space-y-3">
                <div className="flex justify-between items-center px-1">
                    <h3 className="text-base font-bold text-white flex items-center gap-2"><Dumbbell size={16} /> Strength Overview</h3>
                </div>

                {strengthStats.length === 0 ? (
                    <GlassCard className="text-center py-5">
                        <p className="text-xs text-secondary">Log workouts with compound lifts (Squat, Bench, Deadlift) to see stats here.</p>
                    </GlassCard>
                ) : (
            ...
            <div className="space-y-3">
                <div className="flex justify-between items-center px-1">
                    <h3 className="text-base font-bold text-white flex items-center gap-2"><Camera size={16} /> Progress Photos</h3>
                </div>
