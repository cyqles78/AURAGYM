    ...
    <div className="pb-28 pt-6 space-y-6">
      ...
      <GlassCard className="space-y-6 !p-6">
         <div className="flex items-stretch justify-between">
             ...
             {/* Right: Water */}
             <div className="w-[80px] pl-6 flex flex-col items-center justify-center">
                ...
                <div className="flex items-center space-x-2">
                     <button onClick={() => onUpdateWater(Math.max(0, waterConsumed - 1))} className="h-6 w-6 rounded-full bg-surfaceHighlight text-white flex items-center justify-center hover:bg-white/20">-</button>
                     <span className="text-xs font-bold text-white w-3 text-center">{waterConsumed}</span>
                     <button onClick={() => onUpdateWater(waterConsumed + 1)} className="h-6 w-6 rounded-full bg-surfaceHighlight text-white flex items-center justify-center hover:bg-white/20">+</button>
                </div>
             </div>
         </div>
      </GlassCard>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-bold text-white px-1">Today's Meals</h3>
      ...
      <div className="pt-2">
          <GlassCard>
              <h3 className="text-sm font-bold text-white mb-4">Weekly Calories</h3>
      ...
      <div className="pt-4 border-t border-white/5">
        <div className="flex justify-between items-center mb-4 px-1">
          <h3 className="text-lg font-bold text-white">Your Menu</h3>
        </div>
      ...
      {/* --- WIZARD MODAL --- */}
      {showWizard && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/90 p-4 animate-in fade-in duration-200">
           <div className="w-full max-w-md bg-[#1C1C1E] rounded-[32px] border border-border p-8 pb-10 shadow-2xl">
              <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                     <Sparkles size={24} className="fill-white" /> AI Chef
                  </h2>
                  <button onClick={() => setShowWizard(false)} className="bg-surfaceHighlight p-2 rounded-full text-white"><X size={20}/></button>
              </div>
      ...
      {showQuickLog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 p-4 animate-in fade-in">
             <div className="w-full max-w-sm bg-[#1C1C1E] rounded-[24px] border border-border p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
