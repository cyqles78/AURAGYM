...
export const ProgramBuilderScreen: React.FC<ProgramBuilderScreenProps> = ({ onBack, onProgramCreated }) => {
    ...
    if (step === 'CHOICE') {
        return (
            <div className="pb-24 pt-4 space-y-5 h-full flex flex-col animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="flex-1 flex flex-col justify-center gap-4 px-1">
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border border-white/10 rounded-2xl p-6 text-left transition-all active:scale-[0.98]"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-xl font-bold text-white mb-1.5">Smart Generator</h2>
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-[#1C1C1E] border border-white/10 rounded-2xl p-6 text-left transition-all active:scale-[0.98]"
                    >
                        <div className="relative z-10">
                            <div className="bg-white/10 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
                                <Hammer size={24} className="text-slate-300" />
                            </div>
                            <h2 className="text-xl font-bold text-white mb-1.5">Build Manually</h2>
    ...
    if (step === 'WIZARD_GOAL') {
        return (
            <div className="pb-24 pt-4 space-y-6 animate-in slide-in-from-right">
                <div className="flex items-center space-x-2 px-1">
                    <button onClick={() => setStep('CHOICE')} className="p-2 -ml-2 rounded-full active:scale-95 text-white">
                        <ArrowLeft size={20} />
                    </button>
                ...
                <div className="px-1">
                    <h2 className="text-2xl font-bold text-white mb-1.5">What is your primary focus?</h2>
                    <p className="text-slate-400 text-xs">We will adjust sets, reps, and volume accordingly.</p>
                </div>
                ...
                <div className="space-y-2.5">
                    {[
                        ...
                        <button
                            ...
                            className="w-full bg-[#1C1C1E] border border-white/10 p-4 rounded-2xl flex items-center justify-between group active:scale-[0.98] transition"
                        >
                            ...
                            <ChevronRight size={18} className="text-slate-600 group-active:text-white transition-colors" />
                        </button>
                    ))}
                </div>
            </div>
    ...
    if (step === 'WIZARD_DETAILS') {
        return (
            <div className="pb-24 pt-4 space-y-6 animate-in slide-in-from-right">
                <div className="flex items-center space-x-2 px-1">
                    <button onClick={() => setStep('WIZARD_GOAL')} className="p-2 -ml-2 rounded-full active:scale-95 text-white">
                        <ArrowLeft size={20} />
                    </button>
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">Step 2 of 2</span>
                </div>

                <div className="px-1">
                    <h2 className="text-2xl font-bold text-white mb-1.5">Fine Tuning</h2>
                    <p className="text-slate-400 text-xs">Configure your schedule and timeline.</p>
                </div>
                ...
                <GlassCard className="space-y-6">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-3">
                            <label className="text-white font-bold flex items-center gap-2 text-sm">
                                <Calendar size={16} className="text-accent" /> Days Per Week
                            </label>
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-3">
                            <label className="text-white font-bold flex items-center gap-2 text-sm">
                                <Layers size={16} className="text-accent" /> Program Length
                            </label>
                            <span className="text-xl font-black text-white">{weeks} <span className="text-xs font-normal text-secondary">Wks</span></span>
                        </div>
                        <input
                ...
                <button
                    ...
                    className="w-full py-3.5 bg-white text-black font-black text-base rounded-2xl flex items-center justify-center gap-2 shadow-xl active:scale-[0.98] transition"
                >
